...
const std::string& Car::getMake() const {
  cr::printOut(cr::YELLOW, "getMake() Called") ;
  return _make ;
}

const std::string& Car::getModel() const {
  cr::printOut(cr::YELLOW, "getModel() Called") ;
  return _model ;
}

const int16_t& Car::getYear() const {
  cr::printOut(cr::YELLOW, "getYear() Called") ;
  return _year ;
}
// ******************
//  GETTERS ENDS    *
...
void    Car::setMake(const std::string & make) {
  cr::printOut(cr::YELLOW, "setMake() Called") ;
  _make = make ;
}

void    Car::setModel(const std::string & model) {
  cr::printOut(cr::YELLOW, "setModel() Called") ;
  _model = model ;
}

void    Car::setYear(const int16_t & year) {
  cr::printOut(cr::YELLOW, "setYear() Called") ;
  _year = year ;
}
// ******************
//  SETTERS ENDS    *
